...
void initFlipper(void)
{
    ...
    flipper.angle = FLIPPER_REST_ANGLE;
    flipper.flipstate = 0;
    flipper.rvel = 0;
}
...
void physics(void)
{
    ...
    flipperBallCollision(flipper, ball2);
/*
...
void render(void)
{
    ...
    // debug lines
   /* Vec between;
    VecBtn(flipper.pos, ball1.pos, between);
    double projectX = VecProject(between, horz);
    double projectY = VecProject(between, vert);
    
    VecScale(vert, projectY, vert);
    VecScale(horz, projectX, horz);
